...
describe("error handling", function() {
  ...
  it("throws error on missing value when value is unquoted", function() {
    try {
      ...
      assert.isOk(errorChecker("key", 3, MissingValueError,err))
    }
  });
  ...
  it("throws error on missing value when value is quoted", function() {
    try {
      ...
      assert.isOk(errorChecker("key", 9, MissingEndQuoteError, err))
    }
  });
  ...
  it("throws error on missing key", function() {
    try {
      ...
      assert.isOk(errorChecker(undefined, 0, MissingKeyError, err))
    }
  });
  ...
  it("throws error on missing assignment operator", function() {
    try {
      ...
      assert.isOk(errorChecker(undefined, 4, MissingAssignmentOperatorError, err))
    }
  });
  ...
  it("throws error on incomplete key value pair", function() {
    try {
      ...
      assert.isOk(errorChecker(undefined, 2, IncompleteKeyValuePairError,err))
    }
  });
